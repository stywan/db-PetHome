...
-- ALTER TABLE veterinario ADD CONSTRAINT chk_vet_aprobado CHECK (aprobado IN ('0','1'));
-- ALTER TABLE veterinario ADD CONSTRAINT fk_vet_aprobador FOREIGN KEY (aprobado_por) REFERENCES usuario(id);
...
ALTER TABLE cita ADD CONSTRAINT chk_cita_estado CHECK (estado IN ('PENDIENTE','CONFIRMADA','CANCELADA','COMPLETADA'));
